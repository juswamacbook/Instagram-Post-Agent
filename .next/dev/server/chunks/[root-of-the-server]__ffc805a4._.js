...
"[project]/IG.AI/src/app/api/palettes/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, context) {
    ...
    const colors = Array.isArray(body.colors) ? body.colors.filter((color)=>typeof color === "string") : undefined;
    const palette = await __TURBOPACK__imported__module__$5b$project$5d2f$IG$2e$AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].palette.update({
        where: {
            id
        },
        data: {
...
async function DELETE(request, context) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$IG$2e$AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].palette.delete({
        where: {
            id
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ffc805a4._.js.map
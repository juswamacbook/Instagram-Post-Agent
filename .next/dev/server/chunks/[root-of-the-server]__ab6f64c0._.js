...
"[project]/IG.AI/src/app/api/brands/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const brands = await __TURBOPACK__imported__module__$5b$project$5d2f$IG$2e$AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].brand.findMany({
            orderBy: {
                createdAt: "desc"
            },
            include: {
...
async function POST(request) {
    ...
    try {
        const brand = await __TURBOPACK__imported__module__$5b$project$5d2f$IG$2e$AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].brand.create({
            data: {
                name: body.name.trim(),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab6f64c0._.js.map
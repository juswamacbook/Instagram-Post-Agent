...
"[project]/IG.AI/src/app/api/palettes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const palettes = await __TURBOPACK__imported__module__$5b$project$5d2f$IG$2e$AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].palette.findMany({
        where: brandId ? {
            brandId
        } : undefined,
        orderBy: {
...
async function POST(request) {
    ...
    const colors = Array.isArray(body.colors) ? body.colors.filter((color)=>typeof color === "string") : [];
    const palette = await __TURBOPACK__imported__module__$5b$project$5d2f$IG$2e$AI$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].palette.create({
        data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__134311d7._.js.map